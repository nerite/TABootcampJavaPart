 ...
 * @Purpose to explain Multi-dimensional array declaration
 */
...
public class MultiDimensionalArraySample {
    public static void main(String[] args) {
         ...
         * still say that it's a one dimensional array with arrays as its members
         */

        System.out.println("Access integer array location 1, 1: " + anotherIntegerArray[1][1]);
        System.out.println("Access integer array location 0, 2: " + anotherIntegerArray[0][2]);
    }
}
